...
const fetchPlaylist = async() => {
    const url = `https://api.spotify.com/v1/users/31miljooa7ddthgwluhd2rmuchmq/playlists`
    const request = await fetch(url, {
        headers: {
            Authorization: 'Bearer BQC1kyo1ASytOJmMQD-t9e5TdIPZUOkS12HGdMTFN-Lx1OEZnUV-0JmO7mu-JLy4UTjE3IobfwCCHwPnd2KEm9Aoou2eRgQY4V7m08BWgdxs2gmKAW0vvEn2Ra8N850ns16X7_afdq7ip_7ZEO940z5CvzpGf6oap9Q3DEuNfbxYrzjbNg3SM0k5hid-1bIQY0SjWvb_WLeQ1PI9fhb-xiY3Rg2HAgeKFJDW'
        }
    })
